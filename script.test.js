...
describe("testing if it clones the array", () => {
  ...
  //checking that it created a clone of the array and that it's not the array but the clone we're dealing with
...
//test to check the length of an array and to check that it added a programming language to the array
describe("programming languages array", () => {
  //Checking the length
  test("should have initial length of 6", () => {
    expect(programmingLanguages.length).toBe(6);
  });
  //checking it adds the programming language
